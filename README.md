...
Based on the regression analysis, we interpreted the significance of the Region, Industry, Programs, and Disbursement to date to the allocation of awards from the Department of State in New York. In accordance with that, for every additional dollar spent in the Disbursement to Date, the allocation of awards is estimated to increase by approximately $0.02319, and is statistically significant ( p = 0.018). For Northwest region, residing in this region is associated with an estimated increase of approximately $745,300 in the allocation of awards compared to the reference region. Similar interpretations would apply to the Southeast and Southwest regions, where being in those regions is associated with estimated increases of approximately $965,600 and $1,324,000, respectively, in the allocation of awards compared to the reference region. For instance, if we compare different regions, like the Northwest, Southeast, and Southwest to a reference region, the numbers tell us how much, on average, state awards are expected to change in dollars. For example, for the Northwest region, being located there is associated with an estimated increase of about $745,300 in state awards compared to the reference region. These differences are statistically significant, meaning they are likely not random (p = 0.006). So, being in the Northwest region, on average, seems to bring in more state awards compared to the reference region. Also, for industries such as food service. The data suggests that for every additional dollar spent in the food services sector, the data indicates a decrease of approximately $767,700 in the total state awards, on average. In other words, investing more money in the food services industry appears to be associated with a reduction in state awards, and this decrease is statistically significant. Now, lets jump into program types. The coefficients tell us how additional dollars spent in specific program types impact the total state awards in dollars. For instance, if we invest an extra dollar in a "Development" program, it's estimated to lead to an increase of about $2,997,000 in state awards compared to the reference category. This increase is statistically significant (p < 0.001). In simpler terms, spending more in development programs seems to bring in more state awards, and this increase is very likely not due to chance. Some program types, like "Innovation/Education" and "Misc.," also show significant impacts, suggesting that every extra dollar spent in these programs leads to a substantial increase in state awards. However, not all program types show such significant impacts.
